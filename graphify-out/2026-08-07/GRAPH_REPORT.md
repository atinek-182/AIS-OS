...
## Corpus Check
- 542 files · ~2,035,398 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5213 nodes · 4969 edges · 476 communities (438 shown, 38 thin omitted)
...
- `mirror_site()` --calls--> `html_to_jsx()`  [INFERRED]
  scripts/scrape_full_site_mirror.py → scripts/extract_components_batch.py

## Import Cycles
- None detected.

## Communities (476 total, 38 thin omitted)
...
### Community 1 - "Q&A Log"
Cohesion: 0.17
Nodes (11): Domain Vocabulary & Glossary (CONTEXT.md updates), Executive Summary & Key Decisions, Q1 — Scaffolding Mode & Deep Q&A Protocol, Q2 — Project-Local `reference/` Design Vault & Style Adaptation, Q3 — Automated Playwright QA & Human-in-the-Loop Visual Feedback Gate, Q4 — Per-Reference Granular Deconstruction & Adaptation Interview, Q5 — 4-Phase Deep Interview (`init`) + Feature-Specific Socratic Spec Sessions, Q6 — Interactive Human-in-the-Loop Visual QA & Screenshot Feedback Protocol (+3 more)

### Community 2 - "Upgrade Web Design Skill (`website-design-engine`): Socratic Discovery & Brainstorm Notes"
Cohesion: 0.22
...
Cohesion: 0.17
Nodes (11): 1. The Contrarian (Red Team) — "How does this die?", 2. The Expansionist (Bull) — "Where is the 10x leverage?", 3. The Logician (First Principles) — "Does the math hold together?", 4. The Researcher (Evidence) — "What does market data say?", 👥 5-Persona Council Audits, 5. The Buyer (Voice of Customer / SMB Owner) — "Would I buy this?", 📊 Council Scores, 🛠️ The 3 Necessary Strategic Refinements (+3 more)

### Community 9 - "ZORIXEL Agency Positioning & Strategy: Socratic Discovery & Brainstorm Notes"
Cohesion: 0.18
Nodes (10): Domain Vocabulary & Glossary (CONTEXT.md updates), Executive Summary & Key Decisions, Open Flags & Deferred Decisions, Q1 — Primary Brand Category & Positioning Statement, Q2 — Pricing Architecture & Micro-Service Proof Ladder, Q3 — Client Acquisition Funnel & Intake Mechanics, Q4 — Handover Infrastructure & Code Ownership Policy, Q&A Log (+2 more)

### Community 10 - "Client Vault & Directory Architecture: Discovery & Brainstorm Notes"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (8): 1. Zero-Upfront Flagship Pilot Agreement (Phase 1), 2. Quantified ROI & Cost Floor Calculations, 3. Post-Pilot Commercial Expansion Tiers (Nate Herk Masterclass Model), 4. Agreement & Outreach Tracking, Option 1: Essential Journal & Intake Automation Sprint, Option 2: Fullstack Editorial & CRM Growth Engine (Recommended), Option 3: Fractional AI Officer & Retainer Partnership, Phase 02: Proposal, Financial Calculations & Agreement
...
### Community 21 - "ZORIXEL AIOS Session Post-Mortem, Error Catalog & System Evolution Report"
Cohesion: 0.11
Nodes (17): 1. `pdf-document-creation-engine` Skill Specification, 2. `native-brand-font-renderer` Skill Specification, Appended Workspace Prevention Rules (Rules 1.17 – 1.20), Detailed Error Breakdowns, ERR-2026-01: SVG Stroke Bleed Inside Letter Counter Holes, ERR-2026-02: Stray Path Coordinate Line Across Letter 'o', ERR-2026-03: Dark Mode PDF Print Background & Margin Bleed, Error Categorization Matrix (+9 more)
...
### Community 129 - "design-optimizer/prepare.py"
Cohesion: 0.47
...
### Community 139 - "Cross-Site Request Forgery (CSRF)"
Cohesion: 0.40
...
## Knowledge Gaps
- **3666 isolated node(s):** `{ chromium }`, `fs`, `path`, `OUTPUT_FILE`, `fs` (+3661 more)
