# AIS-OS â€” AI Operating System starter kit for Antigravity

A free, MIT-licensed starter kit that turns Antigravity into your personal **AI Operating System (AIOS)**. Audience: anyone building automations â€” solopreneurs, small business operators, managers, creators, AI consultants. Pairs with a companion masterclass video.
...
> **AIS-OS** stands for **AI Automation Society OS** â€” the way Nate designed this AIOS to be set up for members of his community, [AI Automation Society](https://www.skool.com/ai-automation-society). The kit is universal (it works for anyone), but the structure mirrors how AIS members run their own businesses on top of it.
...
Three felt **success indicators** tell you the AIOS is actually changing how you work. Not KPIs â€” there's no objective metric. These are lived experiences that show up in your week.

**1. Team-reaches-out:**

> *"A teammate messages you with a question. You realize your AIOS would answer it better, faster, and with exact sources â€” even if you were awake and free. So you ask your AIOS too. That's the moment you stop being a bottleneck for your own knowledge."*
...
### The Three Ms â€” operator brain (how you think)

| M | One-liner |
|---|---|
| **Mindset** | Default Shift, Function Breakdown, Curiosity Rule. *To what extent can AI be leveraged here?* |
| **Method** | Find Constraint â†’ EAD (Eliminate, Automate, Delegate) â†’ Map Process â†’ Pick Autonomy Level â†’ Tie to KPI. |
...
> *The Three Ms of AIâ„¢ is a trademark of Nate Herk. Â© 2026 Nate Herk.*

### The Four Cs â€” architecture (what you build)
...
| 2 | **Connections** | Reaches your stuff | "What's on my calendar tomorrow and what tasks are due?" â†’ live data, no paste |
...
> *The Four Cs of an AIOSâ„¢ is a trademark of Nate Herk. Â© 2026 Nate Herk.*

Dependency graph: Context is non-skippable. Connections + Capabilities can build in parallel. Cadence is last â€” don't automate workflows that don't work manually.

---

## What ships â€” 3 skills
...
| `/level-up` | Recurring thinking skill | Day 14, then weekly. Three Ms interview (Mindset â†’ Method â†’ Machine). One run = one shipped artifact. |

`/audit` asks *"is the AIOS built right?"* (form). `/level-up` asks *"what business leverage am I missing?"* (function). They work in series â€” fix structure first, then capability planning becomes meaningful.
...
AIS-OS/
â”œâ”€â”€ README.md
â”œâ”€â”€ GEMINI.md                        â† Your operating manual (filled by /onboard)
â”œâ”€â”€ EXPANSIONS.md                    â† What to add as you grow
â”œâ”€â”€ LICENSE
â”œâ”€â”€ .gitignore
â”œâ”€â”€ aios-intake.md                   â† Source-of-truth for /onboard. Edit + re-run any time.
â”œâ”€â”€ connections.md                   â† Registry of every system your AIOS can reach
â”œâ”€â”€ context/                         â† About you, your business (filled by /onboard)
â”œâ”€â”€ references/
â”‚   â””â”€â”€ 3ms-framework.md             â† The operator brain
â”œâ”€â”€ decisions/
â”‚   â””â”€â”€ log.md                       â† Append-only record of what was decided and why
â”œâ”€â”€ archives/                        â† Old stuff. Don't delete. Move here.
â””â”€â”€ .agents/
    â””â”€â”€ skills/
        â”œâ”€â”€ onboard/SKILL.md
        â”œâ”€â”€ audit/SKILL.md
        â””â”€â”€ level-up/SKILL.md
```

See `EXPANSIONS.md` for what to add as you grow (`projects/`, `templates/`, `scripts/`, `.agents/agents/`, sub-OS folders, etc.).

---

## License + attribution

MIT License. Â© 2026 Nate Herk.

The Three Ms of AIâ„¢ and The Four Cs of an AIOSâ„¢ are trademarks of Nate Herk. Both frameworks ship in this repo with attribution. Use freely; don't repackage as your own.
