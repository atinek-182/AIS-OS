...
- For the project-wide Definition of Done that every change must clear before this checklist, see `../../references/sdlc/definition-of-done.md`
- For security pre-launch checks, see `../../references/sdlc/security-checklist.md`
- For performance pre-launch checklist, see `../../references/sdlc/performance-checklist.md`
- For accessibility verification before launch, see `../../references/sdlc/accessibility-checklist.md`
