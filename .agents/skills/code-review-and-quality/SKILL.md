...
- For detailed security review guidance, see `../../references/sdlc/security-checklist.md`
- For performance review checks, see `../../references/sdlc/performance-checklist.md`
