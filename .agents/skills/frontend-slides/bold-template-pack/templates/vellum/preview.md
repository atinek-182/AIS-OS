...
critical_directives:
- 'Signature move: Dusty teal ({colors.teal}) is the second accent — used only for the large quote-mark glyph, the pin-note'
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/vellum/preview.md
- When reading context for Vellum Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
