...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/coral/preview.md
- When reading context for Coral Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
