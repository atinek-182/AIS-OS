---
title: Soft Editorial Preview Card
domain: skill
...
critical_directives:
- 'Signature move: Single warm cream surface ({colors.paper}) across every slide; pastels appear only as card fills, never '
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/soft-editorial/preview.md
- When reading context for Soft Editorial Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
