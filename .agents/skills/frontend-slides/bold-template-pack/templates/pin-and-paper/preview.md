...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/pin-and-paper/preview.md
- When reading context for Pin & Paper Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
