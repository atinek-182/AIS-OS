---
title: Bold Poster Preview Card
domain: skill
...
critical_directives:
- 'Signature move: Single tomato red ({colors.red}) as the only accent — used for every numerical figure, every section rul'
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/bold-poster/preview.md
- When reading context for Bold Poster Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
