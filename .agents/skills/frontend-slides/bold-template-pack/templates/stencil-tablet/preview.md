---
title: Stencil & Tablet Preview Card
domain: skill
...
critical_directives:
- 'Signature move: Seven-color accent palette ({colors.sienna}, {colors.magenta}, {colors.orange}, {colors.teal}, {colors.b'
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/stencil-tablet/preview.md
- When reading context for Stencil & Tablet Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
