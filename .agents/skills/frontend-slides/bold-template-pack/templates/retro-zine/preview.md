...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/retro-zine/preview.md
- When reading context for Retro Zine Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
