...
critical_directives:
- 'Signature move: Cream paper background ({colors.cream-paper}) on every slide — never white, never dark by default. The
  c'
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/monochrome/preview.md
- When reading context for Monochrome Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
