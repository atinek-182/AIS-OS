---
title: Pink Script — After Hours Preview Card
domain: skill
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/pink-script/preview.md
- When reading context for Pink Script — After Hours Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
