---
title: Creative Mode Preview Card
domain: skill
...
critical_directives:
- 'Signature move: Four accent colors used as flat fills; each slide uses two or three of the four, never all simultaneousl'
...
- Preview Ingredients
read_triggers:
- When working on skill in .agents/skills/frontend-slides/bold-template-pack/templates/creative-mode/preview.md
- When reading context for Creative Mode Preview Card
tags:
- skill
- preview
updated: '2026-08-08'
