...
| [brainstorms/2026-08-08-ingest-detect-skill.md](file:///d:/AI-OS/brainstorms/2026-08-08-ingest-detect-skill.md) | File | Ingestion discovery capture file for Resemble AI detect-skill deepfake detection engine. | AIOS |
| [.agents/skills/resemble-detect/SKILL.md](file:///d:/AI-OS/.agents/skills/resemble-detect/SKILL.md) | File | Tier 1 native skill for Resemble AI deepfake detection, audio source tracing, and media safety. | AIOS |
| [scripts/resemble_detect_runner.py](file:///d:/AI-OS/scripts/resemble_detect_runner.py) | File | Python CLI runner for Resemble AI REST API v2 handling URL, file upload, secure upload, and polling. | AIOS |
